...
architectural thought is written in: the **architectural register** (the ho document—decisions, reasoning, reflection, read by humans) and the **executable register** (the

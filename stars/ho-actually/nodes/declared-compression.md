---
id: declared-compression
title: declared compression
type: procedure
requires: []
related: [compressed-chain, ho-00, ho-overview, kamae]
entry_points: [declared compression]
summary: >
...
<!-- depth:3 -->
<!-- provenance: extracted -->
The ri-stage move of combining or skipping Kamae chain layers,
...
framework's own ho overview runs on one.

<!-- depth:4 -->
<!-- provenance: extracted -->
**When to Do What.** ### For a Brand-New Project

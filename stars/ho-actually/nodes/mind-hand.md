...
related: [agent-task, kamae, phase]
entry_points: [mind / hand]
summary: >
...
<!-- depth:3 -->
<!-- provenance: extracted -->
The framework's central operating principle: one architectural thought
...
<!-- depth:4 -->
<!-- provenance: extracted -->
**The two-tier separation of thinking from coding—mind and hand.** The registers are the session-scale instance of the methodology's central operating
